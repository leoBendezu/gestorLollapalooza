...
namespace gestorLollapalooza.Service
{
    ...
    {
        private TipoEntradaDao tipoEntradaObj;

        public TipoEntradaService()
        {
            this.tipoEntradaObj = new TipoEntradaDao();
        }
        ...
        public bool borrarLogicamente(string nombre)
        {
            ...
            return (this.tipoEntradaObj.borradoLogicamente(nombre));
        }
        

        public IList<TipoEntrada> RecuperarTodos()
        {
            ...
            IList<TipoEntrada> tipoEntradas = tipoEntradaObj.obtenerTodos();
            return tipoEntradas;

        }

        public IList<TipoEntrada> obtenerFiltados(string filtros)
        {
            ...
            return tipoEntradaObj.recuperarFiltrados(filtros);
        }
        ...
        public bool PersistirTipoEntrada(TipoEntrada tipoEntrada)
        {
            ...
            return tipoEntradaObj.persistirTipoEntrada(tipoEntrada);
        }
        ...
        public TipoEntrada recuperarTipoEntrada(string nombre)
        {
            ...
            return tipoEntradaObj.recuperarTipoEntrada(nombre);
        }

        public bool ExisteTipoEntrada(string nombre)
        {
            ...
            return (tipoEntradaObj.recuperarTipoEntrada(nombre) != null);
        }
        ...
        public bool modificarTipoEntrada(TipoEntrada tipoEntrada)
        {
            ...
            return this.tipoEntradaObj.modificarTipoEntrada(tipoEntrada);
        }
